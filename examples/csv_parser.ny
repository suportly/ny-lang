...
fn main() -> i32 {
    ...
    avg := total / num_rows;
    println("");
    println("  Students: " + to_str(num_rows));
    println("  Total: " + to_str(total) + ", Average: " + to_str(avg));
    println("  Min: " + to_str(min_score) + ", Max: " + to_str(max_score));
    println("");
